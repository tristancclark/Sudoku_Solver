...
{
  //use to label recursion level
  static int level = 0;
  level++;
  cout << "RECURdfdSION LEVEL: " << level << endl;
  ...
  else
  {
    ...
    do
    {
      ...
      //cout << "DURING WHILE LOOP: trying digit " << current_digit << " in position: row " << row << " and column " << column << endl;
